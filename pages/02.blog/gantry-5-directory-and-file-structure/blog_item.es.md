...
metadata:
    ...
    'og:image': 'https://othercode.io/user/pages/02.blog/gantry-5-directory-and-file-structure/style-editor-cfg-file-example.webp'
    ...
    'twitter:image': 'https://othercode.io/user/pages/02.blog/gantry-5-directory-and-file-structure/style-editor-cfg-file-example.webp'
    'article:published_time': '2018-12-26T00:00:00+10:00'
    'article:modified_time': '2024-05-17T20:51:22+10:00'
...
aura:
    ...
    pagetype: article
    description: 'En este articulo conoceremos la estructura de ficheros de nuestra plantilla y prenderemos para que sirven cada uno de los diferentes archivos de configuración.'
    image: style-editor-cfg-file-example.webp
---
